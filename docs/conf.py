# -*- coding: utf-8 -*-
#
# pyblast documentation build configuration file, created by
...
from pyblast import __version__ as pyblast_version
...
version = pyblast_version
# The full version, including alpha/beta/rc tags.
release = pyblast_version
...
latex_documents = [
    (master_doc, 'pyblast.tex', u'pyblast Documentation',
...
man_pages = [
    (master_doc, 'pyblast', u'pyblast Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pyblast', u'pyblast Documentation',
     author, 'pyblast', 'White dwarf Accretion w/ COSMIC.',
     'Miscellaneous'),
]
